...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    }, i = "ABCDEFGHIJKLMNOPQRSTUVWXYZ", r = i.toLowerCase(), n = {
        upperCase: new s(i),
        lowerCase: new s(r),
        upperAndLowerCase: new s(i + r)
    }, h = "codepen", o = "ScrambleTextPlugin", a = "", l = "", _ = function (t) {
    ...
    }(window ? window.location.host : ""), g = _gsScope._gsDefine.plugin({
        propName: "scrambleText", version: "0.4.0", API: 2, overwriteProps: ["scrambleText", "text"], init: function (e, i, r, g) {
            ...
            "function" == typeof i && (i = i(g, e)), this._target = e, "object" != typeof i && (i = {text: i});
            var f, C, d, p;
            ...
            var e, s, i, r, n, h, o, a, l = this._text.length, _ = this._delimiter, g = this._tween._time, f = g - this._prevScrambleTime;
